...
class Bookmarks(db.Model):
    sno = db.Column(db.Integer, primary_key=True)
    email = db.Column(db.String(200), nullable = False)
    bookmark_ist = db.Column(db.String(10000), nullable = True)
    date_time = db.Column(db.String(50), nullable = True)
...
def signin():
    if "user" in session:
        ...
        return render_template('signin/signin.html', session=session)
